...
const ChatFooter=({socket,currentChat,setMessages,messages}:{socket:Socket|null,currentChat:ChatListInterface|null,setMessages:Dispatch<SetStateAction<ChatMessageInterface[]>>,messages:ChatMessageInterface[] })=>{
    ...
    const handleTypingMessageChange=(e:React.ChangeEvent<HTMLInputElement>)=>{
             ...
             <div className="flex items-center bg-chat-child-container w-[61.9vw] justify-between py-3 pl-5 pr-20" >
                ...
                <div className="pl-5" >
                    <div>
                        ...
                        onChange={(e)=>{ handleTypingMessageChange(e) }}
