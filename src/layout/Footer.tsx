...
const Footer = () => {
    return (
        <>
            <div className="bg-black flex items-center gap-10 py-5 xsm:gap-0" >
                <div className="w-2/5  flex items-center justify-center  " >
                    <img src={LOGO2} className="w-1/3 " />
                </div>
                ...
                <div className="flex gap-5  " >
                    ...
                    <div className="flex flex-col gap-5 " >
                        <div>
                            <p className="text-gray-400 " >NOT QUITE READY FOR JCHAT?</p>
                        </div>
                        <div className="flex flex-col gap-3" >
                            <div>
                            ...
                            <div className="flex gap-5 items-center xsm:flex-col " >
                                <div className="py-3 rounded-full bg-white flex xsm:px-0 xsm:py-1 xsm:items-center" >
                                    <div>
                                        <input type="text" placeholder="Enter Email" className=" rounded-full outline-none p-2 xsm:px-0 xsm:py-1" />
                                    </div>
